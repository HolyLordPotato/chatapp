...
function renderMessage({ username, text, timestamp, socketId }) {
    ...
    div.innerHTML = `
      <div class="avatar ${avatarColor(username)}">${initials(username)}</div>
      <div class="msg-body">
...
function renderTyping() {
    ...
    typingBar.innerHTML = `div class="typing-dots"><span></span><span></span><span></span></div><span>${names} ${label}...</span>`;
...
socket.om("chat:message", renderMessage);
